...
public class CodexSDKBridgeTest {
    ...
    @Test
    public void buildResumeMessageDropsReasoningButKeepsRestoreOptions() throws Exception {
        CodexSDKBridge bridge = createBridge();
        JsonObject message = invokeBuildResumeMessage(bridge, "thread-1", "continue", "/workspace");
    ...
    private static JsonObject invokeBuildResumeMessage(
        ...
        method.setAccessible(true);
        return (JsonObject) method.invoke(bridge, sessionId, prompt, cwd);
    }
